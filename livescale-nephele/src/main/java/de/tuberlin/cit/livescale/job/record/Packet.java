...
public class Packet extends AbstractTaggableRecord {
	 ...
	 * @param streamId
	 */
	public Packet(long streamId, long groupId, int packetIdInStream, byte[] data) {
	...
	public void set(int streamId, long groupId, int packetIdInStream, byte[] data, int offset, int len) {
		this.groupId = groupId;
		this.streamId = streamId;
		this.packetIdInStream = packetIdInStream;
