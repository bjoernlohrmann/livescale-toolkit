...
/**
 * This {@link Message} encapsulates a client request to the dispatcher asking
 * for an endpoint it may stream to.
 * 
 * The corresponding return message is a {@link ClientStreamSend}.
 * 
 * This is a dispatcher-broadcast.
 * 
 * @author Bernd Louis
 */
public class DispatcherRequestStreamSend extends RequestMessage {
	...
	public ResponseMessage getResponseMessage() {
		return new ClientStreamSend(this.getUUID());
	}
