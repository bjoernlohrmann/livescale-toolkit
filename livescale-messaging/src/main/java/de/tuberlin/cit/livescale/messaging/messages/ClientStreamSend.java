...
/**
 * {@link ResponseMessage} from the dispatcher to the client issuing that
 * streaming is now ready.
 * 
 * This is a response to {@link DispatcherRequestStreamSend}
 * 
 * @author Bernd Louis
 * 
 */
public class ClientStreamSend extends ResponseMessage {
	 ...
	 */
	public ClientStreamSend(UUID requestMessageUUID) {
